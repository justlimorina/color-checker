...
### ♿ WCAG, Tương phản Tự do & Ma trận Tương phản
...
- **Ma trận tương phản (Contrast Matrix):** Bảng so sánh chéo tỉ lệ tương phản WCAG giữa toàn bộ các màu bạn đã lưu (Saved Palette) cùng Trắng và Đen để nhanh chóng tìm ra các cặp màu chữ/nền phù hợp nhất.
